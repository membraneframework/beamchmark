defmodule Beamchmark.Formatters.HTML.Templates do
  ...
  def format_average_cpu_usage(cpu_snapshots_reversed) do
    ...
    %{
      ...
      time: Enum.map_join(cpu_snapshots, ", ", fn snapshot -> snapshot.timestamp end)
    }
  end
  ...
  def format_cpu_usage_by_core(cpu_snapshots_reversed) do
    ...
    %{
      ...
      time: Enum.map_join(cpu_snapshots_reversed, ", ", fn snapshot -> snapshot.timestamp end),
  ...
  def format_memory_usage(memory_snapshots_reversed) do
    ...
    %{
      ...
      time: Enum.map_join(memory_snapshots, ", ", fn snapshot -> snapshot.timestamp end)
    }
  end
